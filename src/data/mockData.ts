...
export const CURRENT_ORDER: OrderTicket = {
  ...
  membershipLevel: 'Atelier Membership Elite • Khắc Laser Tên Riêng',
  editionName: '12 Thẻ Tháng 100% In Trên Giấy Mỹ Thuật Cotton 310gsm',
  woodBase: 'Đế gỗ tự nhiên tiện rãnh dễ tìm (hoặc Khung để bàn tiêu chuẩn)',
  finishDetail: '100% in trên giấy mỹ thuật • Khắc laser mặt trước đế gỗ mộc',
  dimensions: '16 x 24 cm (Khổ đứng Portrait)',
  paperStock: 'Hahnemühle 310gsm Cotton Archival Đức (100% Giấy)',
